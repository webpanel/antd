...
var ForgotPassword = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.props.onSend(values.email)];
                    case 1:
                        _a.sent();
    ...
    ForgotPassword.prototype.render = function () {
        var _this = this;
        return (React.createElement(Form, { onSave: this.onSubmit, render: function () { return (React.createElement(React.Fragment, null,
                React.createElement(AForm.Item, { label: "Email" },
                    React.createElement(Input, { name: "email" })),
                React.createElement(AForm.Item, null,
                    React.createElement(Button, { type: "primary", htmlType: "submit", loading: _this.state.loading }, "Send")))); } }));
    };
