...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function () {
        ...
        //   : undefined;
        var _a = this.props, rowKey = _a.rowKey, dataSource = _a.dataSource, resourceCollection = _a.resourceCollection, restProps = __rest(_a, ["rowKey", "dataSource", "resourceCollection"]);
        ...
        return (React.createElement(AntdTable, __assign({ rowKey: rowKey ? rowKey : function (record) { return record.id; }, rowSelection: rowSelection, loading: this.props.resourceCollection
                ...
                : false, dataSource: data }, restProps)));
    };
    Table = __decorate([
        observer
    ], Table);
