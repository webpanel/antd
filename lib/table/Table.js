        ...
        var _columns = (columns || []).concat([
            {
                ...
                render: function (value, record, index) {
                    return (React.createElement(TableActionButtons, { resourceCollection: resourceCollection, id: _this.getRecordKey(record, index), onDelete: _this.reloadData, buttons: actionButtons || ['edit', 'delete'], detailButtonText: detailButtonText }));
                }
            }
        ]).map(function (c) {
