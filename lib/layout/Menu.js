...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.render = function () {
        ...
        return (React.createElement(Route, { path: "*", exact: true, children: function (_a) {
                var match = _a.match;
                return (React.createElement(AntdMenu, __assign({ mode: "inline", selectedKeys: _this.defaultSelectedKeys(match), defaultOpenKeys: _this.defaultOpenKeys(match) }, _this.props), _this.renderItems(items, '/')));
            } }));
    };
    return Menu;
}(React.Component));
