    ...
    Layout.prototype.render = function () {
        ...
        return (React.createElement(BrowserRouter, null,
            React.createElement(LayoutComponent, { className: "full-height" },
                React.createElement(Sider, { theme: "dark", collapsible: true, collapsed: this.state.collapsed, onCollapse: function (collapsed) {
                ...
                React.createElement(LayoutComponent, null,
                    React.createElement(Header, __assign({ onMenuSelect: function (param) { return _this.handleMenuClick(param); }, username: this.props.userName }, this.props.header)),
                    structures,
