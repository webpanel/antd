...
var InputTextAreaComponent = /** @class */ (function (_super) {
    ...
    function InputTextAreaComponent() {
        ...
        _this.wrapInFieldDecorator = function (elm) {
            ...
            var initialValue = _this.props.initialValue || initialValues[_this.props.name];
    ...
    InputTextAreaComponent.prototype.render = function () {
        var _a = this.props, formContext = _a.formContext, props = __rest(_a, ["formContext"]);
        return this.wrapInFieldDecorator(React.createElement(AntdInput.TextArea, __assign({}, props)));
    };
...
var InputTextArea = /** @class */ (function (_super) {
    ...
    InputTextArea.prototype.render = function () {
        var _this = this;
        return (React.createElement(Subscriber, { channel: "form-context" }, function (context) { return (React.createElement(InputTextAreaComponent, __assign({}, _this.props, { formContext: context }))); }));
    };
