...
var FormField = /** @class */ (function (_super) {
    ...
    function FormField() {
        ...
        _this.decoratedChildren = function (context) {
            ...
            props.normalize = function (value, prevValue, allValues) {
            ...
            if (Array.isArray(children)) {
                return children
                    ...
                    .map(function (elm) { return form.getFieldDecorator(_this.props.name, props)(elm); });
            }
            return form.getFieldDecorator(_this.props.name, props)(children);
        };
        return _this;
    }
