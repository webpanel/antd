...
var FormComponent = /** @class */ (function (_super) {
    ...
    function FormComponent() {
        ...
        _this.submit = function (e) {
            e.preventDefault();
            var form = _this.props.form /*, config, context*/;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.props.onSave(values)];
                        case 2:
                            _a.sent();
                            _a.label = 3;
    ...
    FormComponent.prototype.render = function () {
        var _a = this.props, form = _a.form, initialValues = _a.initialValues, onSave = _a.onSave, onError = _a.onError, render = _a.render, formProps = __rest(_a, ["form", "initialValues", "onSave", "onError", "render"]);
        var formContext = {
            form: this.props.form,
            initialValues: initialValues || {}
        };
        return (React.createElement(AForm, __assign({ onSubmit: this.submit }, formProps),
            React.createElement(Broadcast, { channel: "form-context", value: formContext }, render(formContext))));
    };
