...
var FormElement = /** @class */ (function (_super) {
    ...
    FormElement.prototype.render = function () {
        var _this = this;
        return (React.createElement(Subscriber, { channel: "form-context" }, function (context) { return (React.createElement(FormElementComponent, __assign({}, _this.props, { formContext: context, renderElement: _this.getElement() }))); }));
    };
