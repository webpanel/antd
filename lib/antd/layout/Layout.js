...
var Layout = /** @class */ (function (_super) {
    ...
    Layout.prototype.render = function () {
        var _this = this;
        return (React.createElement(LocaleProvider, { locale: locale },
            React.createElement(BrowserRouter, null,
                React.createElement(LayoutComponent, { className: "full-height" },
                    React.createElement(Sider, { collapsible: true, collapsed: this.state.collapsed, onCollapse: function (collapsed) {
                        ...
                        React.createElement(Menu, { items: this.props.menu || [] })),
                    React.createElement(LayoutComponent, null,
                        React.createElement(Header, { onMenuSelect: function (param) { return _this.handleMenuClick(param); }, username: 'john doe' }),
                        React.createElement(Structure, { items: this.props.structure }),
