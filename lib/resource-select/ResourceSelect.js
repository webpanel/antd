...
var ResourceSelect = /** @class */ (function (_super) {
    ...
    ResourceSelect.prototype.render = function () {
        ...
        var name = resourceCollection.name;
        var className = "resource-select__" + name.toLowerCase();
        var options = this.optionsCache || [];
        return (React.createElement(Select
        // onSearch={this.onSearch}
        , __assign({ 
            // onSearch={this.onSearch}
            className: className, showSearch: true, allowClear: true, optionFilterProp: "children", dropdownStyle: { position: 'relative' }, getPopupContainer: function () {
            ...
            this.optionsIds &&
                ...
                currentItem.data && (React.createElement(Select.Option, { key: currentItem.id, value: currentItem.id }, this.getValueForKey(currentItem.data, labelKey))),
            options));
    };
