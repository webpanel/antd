...
var ResourceSelect = /** @class */ (function (_super) {
    ...
    ResourceSelect.prototype.render = function () {
        ...
        , __assign({ 
            // onSearch={this.onSearch}
            // className={className}
            loading: resourceCollection.loading, notFoundContent: resourceCollection.loading ? React.createElement(Spin, { size: "small" }) : null, showSearch: true, allowClear: true, optionFilterProp: "children", dropdownStyle: { position: "relative" }, 
            // getPopupContainer={() =>
