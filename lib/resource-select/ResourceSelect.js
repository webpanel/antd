...
export var ResourceSelectComponent = function (props) {
    ...
    return (React.createElement(Select, __assign({ value: value, loading: drobdownResourceCollection.loading || valuesResourceCollection.loading, onSearch: function (s) { return onSearch(s); }, onChange: onChange, onBlur: function () {
            setHasFocus(false);
            setSearch(undefined);
